class Tess {
  ...
  load() {
    this._status = {};
    this.worker = new Worker("/js/tesseract.worker.js"); // load worker
  ...
  recognize_text(payload) {
    return this._dispatch({ msg: "recognize_text", payload });
  }
}

// Export the same instant everywhere
export default new Tess();